...
This will produce files with the prefix `erroneous_scale_<scale>_` in the corresponding sport subfolders within `src/project/baked_artifacts/` and generate a visualization plot `corruption_comparison.png`.
